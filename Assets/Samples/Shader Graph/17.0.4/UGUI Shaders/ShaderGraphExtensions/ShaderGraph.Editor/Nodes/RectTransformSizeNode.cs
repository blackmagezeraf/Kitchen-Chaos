...
class RectTransformSizeNode : AbstractMaterialNode, IGeneratesBodyCode {
  ...
  public float PreviewScaleFactor {
    get => previewScaleFactor;
    set => previewScaleFactor = value;
  }

  [SerializeField] float previewPixelsPerUnit = 100f;

  public float PreviewPixelsPerUnit {
    get => previewPixelsPerUnit;
    set => previewPixelsPerUnit = value;
  }
  ...
  public sealed override void UpdateNodeAfterDeserialization() {
    ...
    slots.Add(0);
    MaterialSlot slot1 =
      new Vector1MaterialSlot(1, "Scale Factor", "_CanvasScaleFactor", SlotType.Output, PreviewScaleFactor);
    AddSlot(slot1);
    slots.Add(1);
    MaterialSlot slot2 = new Vector1MaterialSlot(2, "Pixel Per Unit", "_CanvasPixelPerUnit", SlotType.Output,
