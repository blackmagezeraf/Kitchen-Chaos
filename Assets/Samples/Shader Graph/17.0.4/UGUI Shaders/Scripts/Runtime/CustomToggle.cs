...
public class CustomToggle : Toggle, IMaterialModifier {
  ...
  private static readonly string          IsOnPropertyName  = "_isOn";
  private const           string          StatePropertyName = "_State";
  ...
  private int IsOnPropertyId {
    get {
      _isOnPropertyId ??= Shader.PropertyToID(IsOnPropertyName);
  ...
  private static void CreateToggleGameObject(MenuCommand command) {
    GameObject go = ObjectFactory.CreateGameObject("SG Toggle", new Type[] {
