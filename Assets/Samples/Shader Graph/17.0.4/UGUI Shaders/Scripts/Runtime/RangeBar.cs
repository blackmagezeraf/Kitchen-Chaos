...
public class RangeBar : UIBehaviour, IMaterialModifier {
  ...
  private Vector4 Vector => new Vector4(Value.x, Value.y, DirectionVector.x, DirectionVector.y);
  ...
  private static void CreateToggleGameObject(MenuCommand command) {
    GameObject go = ObjectFactory.CreateGameObject("Range Bar",
                                                   new System.Type[] {
                                                     typeof(RectTransform), typeof(CanvasRenderer), typeof(Image),
                                                     typeof(RectTransformSize), typeof(RangeBar)
                                                   });
